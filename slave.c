 ...
 *  next available slot in the shared memory. The program uses a 
 *  semaphore to lock the critical section of accessing the shared
 *  memory segment. The pgrogram then closes the shared memory segment 
 *  and terminates.
 ***********************************************************************/
